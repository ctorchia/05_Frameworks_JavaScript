// 1. Color Intermitente en Título
function colorIntermitente(selector) {
	var el = $(".main-titulo");
	setInterval(function() {
	   el.toggleClass('main-titulo-blinking');
	}, 1000);
}
...
// Obtener filas de dulces o columas
...
// 7. Drag and drop de los caramelos
...
// Movimiento sólido del movimiento
...
// Comprobacion automatica de combinaciones
...
// Llenado de espacios automatico
...
// Llamado a Preparacion del Juego
$(function() {
	initGame();
});
